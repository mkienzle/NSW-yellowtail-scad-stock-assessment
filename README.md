...
The data consist of measurements of [age from a sample of commercial catches](Data/GarfishAgeData.csv), [weights from individual fish in specific intervals of age](Data/Mean weight at age.csv), [total catch and purse seine catch and effort](Data/NSW yellowtail scad catch and effort.csv).
